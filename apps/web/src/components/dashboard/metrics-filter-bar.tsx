...
function periodLabel(
  ...
  return (
    METRICS_RANGE_PRESETS.find((preset) => preset.value === range)?.label ??
    "Custom"
  );
}
...
export function MetricsFilterBar({
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        render={<Button variant='outline' className='gap-1.5 text-xs' />}
      >
      ...
      <DropdownMenuContent className='w-64'>
        <DropdownMenuGroup>
          ...
          <DropdownMenuSub>
            <DropdownMenuSubTrigger>
              {range === "custom" ?
                periodLabel("custom", customRange)
              : "Custom"}
            </DropdownMenuSubTrigger>
        ...
        {showCurrencySection && (
          <>
            ...
            <DropdownMenuGroup>
              ...
              <DropdownMenuRadioGroup
                value={viewCurrency}
                onValueChange={onViewCurrencyChange}
              >
