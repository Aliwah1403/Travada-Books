...
const SYSTEM_PROMPT = `You are a filter parser for a document vault app.
...
- name: string | null — document name or description to search for
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.error("parse-vault-filters error:", err)
